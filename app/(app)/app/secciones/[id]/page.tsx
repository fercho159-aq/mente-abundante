            ...
            <section className={styles.donationSection}>
                <div className={styles.donationContent}>
                    ...
                    <p className={styles.donationText}>
                        Si este contenido te ha servido para tu transformación personal, considera hacer una donación para que podamos seguir creando más lecciones.
                    </p>
                    <button className={styles.donateBtn}>
                        Hacer una donación ❤️
                    </button>
                </div>
            </section>
        </div>
